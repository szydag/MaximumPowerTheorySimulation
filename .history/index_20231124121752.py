...
def calculateCircuitPower(voltage, resistances):
    ...
    devre_guc = voltage^2 / totalResistance
    return totalResistance, devre_guc
...
def grafik_olustur(resistances, voltage):
    ...
    for direnç in direnç_aralığı:
        totalResistance, devre_guc = calculateCircuitPower(voltage, resistances + [direnç])
...
def main():
    ...
    totalResistance, devre_guc = calculateCircuitPower(voltage, resistances)
